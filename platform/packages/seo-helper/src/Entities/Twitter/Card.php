...
namespace Fast\SeoHelper\Entities\Twitter;

use Fast\SeoHelper\Contracts\Entities\TwitterCardContract;
use Fast\SeoHelper\Exceptions\InvalidTwitterCardException;
...
class Card implements TwitterCardContract
{
     ...
     * @param  string $type
     *
     * @return \Fast\SeoHelper\Entities\Twitter\Card
     ...
     * @param  string $type
     *
     * @throws \Fast\SeoHelper\Exceptions\InvalidTwitterCardException
     */
