...
namespace Fast\SeoHelper\Bases;

use Fast\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Fast\SeoHelper\Contracts\Helpers\MetaContract;
use Fast\SeoHelper\Contracts\RenderableContract;
use Fast\SeoHelper\Helpers\Meta;
...
abstract class MetaCollection extends Collection implements MetaCollectionContract
{
     ...
     * @param  string $prefix
     *
     * @return \Fast\SeoHelper\Bases\MetaCollection
     */
