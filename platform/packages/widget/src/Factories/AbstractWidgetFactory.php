...
namespace Fast\Widget\Factories;

use Fast\Widget\AbstractWidget;
use Fast\Widget\Contracts\ApplicationWrapperContract;
use Fast\Widget\Misc\InvalidWidgetClassException;
use Fast\Widget\Misc\ViewExpressionTrait;
use Fast\Widget\WidgetId;
use Exception;
