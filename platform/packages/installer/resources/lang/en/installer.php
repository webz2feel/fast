...
return [
     ...
     */
    'welcome'      => [
        'templateTitle' => 'Fast CMS',
        'title'         => 'Fast CMS',
        'message'       => 'Welcome to Fast CMS. Before getting started, we need some information on the database. You will need to know the following items before proceeding.',
        'next'          => 'Let\'s go',
    ],
