...
namespace Fast\Installer\Providers;

use Fast\Base\Supports\Helper;
use Fast\Base\Traits\LoadAndPublishDataTrait;
use Fast\Installer\Http\Middleware\CheckIfInstalledMiddleware;
use Fast\Installer\Http\Middleware\CheckIfInstallingMiddleware;
use Fast\Installer\Http\Middleware\RedirectIfNotInstalledMiddleware;
