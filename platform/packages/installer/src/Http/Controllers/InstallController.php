...
namespace Fast\Installer\Http\Controllers;

use Fast\ACL\Models\User;
use Fast\ACL\Repositories\Interfaces\UserInterface;
use Fast\ACL\Services\ActivateUserService;
use Fast\Base\Supports\Helper;
use Fast\Installer\Events\EnvironmentSaved;
use Fast\Installer\Events\InstallerFinished;
use Fast\Installer\Helpers\DatabaseManager;
use Fast\Installer\Helpers\EnvironmentManager;
use Fast\Installer\Helpers\FinalInstallManager;
use Fast\Installer\Helpers\PermissionsChecker;
use Fast\Installer\Helpers\RequirementsChecker;
use Fast\Installer\Http\Requests\SaveAccountRequest;
use Fast\Installer\Http\Requests\SaveEnvironmentRequest;
