...
use Fast\Base\Facades\DashboardMenuFacade;
use Fast\Base\Facades\PageTitleFacade;
use Fast\Base\Supports\Editor;
use Fast\Base\Supports\PageTitle;
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \Fast\Base\Supports\DashboardMenu
     */
