...
namespace Fast\Setting\Http\Controllers;

use Assets;
use Fast\Base\Supports\Core;
use Fast\Base\Supports\EmailHandler;
use Fast\Setting\Http\Requests\EmailTemplateRequest;
use Fast\Setting\Http\Requests\LicenseSettingRequest;
use Fast\Setting\Http\Requests\MediaSettingRequest;
use Fast\Setting\Http\Requests\SendTestEmailRequest;
use Fast\Setting\Models\Setting;
