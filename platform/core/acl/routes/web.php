...
use Fast\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Fast\ACL\Http\Controllers\Auth\LoginController;
use Fast\ACL\Http\Controllers\Auth\ResetPasswordController;
use Fast\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Fast\ACL\Http\Controllers', 'middleware' => 'web'], function () {
