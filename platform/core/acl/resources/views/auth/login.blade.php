...
@section('content')
    ...
    {!! Form::open(['route' => 'access.login', 'class' => 'login-form']) !!}
        <div class="form-group">
            ...
            {!! Form::text('username', old('username', app()->environment('demo') ? 'fast' : null), ['class' => 'form-control', 'placeholder' => trans('core/acl::auth.login.username')]) !!}
        </div>
        ...
        {!! apply_filters(BASE_FILTER_AFTER_LOGIN_OR_REGISTER_FORM, null, \Fast\ACL\Models\User::class) !!}
