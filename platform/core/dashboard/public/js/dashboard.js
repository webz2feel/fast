    ...
    value: function init() {
      ...
      list_widgets.on('change', '.number_record .numb', function (event) {
        ...
        if (!isNaN(paginate)) {
          ...
          Fast.showError('Please input a number!');
        }
      });
        ...
        success: function success(res) {
          ...
          if (!res.error) {
            ...
            if (el.find('.scroller').length !== 0) {
              Fast.callScroll(el.find('.scroller'));
            }
...
module.exports = __webpack_require__(/*! E:\laragon\www\fast\platform\core\dashboard\resources\assets\js\dashboard.js */"./platform/core/dashboard/resources/assets/js/dashboard.js");
