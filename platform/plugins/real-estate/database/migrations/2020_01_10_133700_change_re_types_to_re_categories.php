...
class ChangeReTypesToReCategories extends Migration
{
    ...
    public function up()
    {
        ...
        if (Schema::hasTable('language_meta')) {
            DB::table('language_meta')->where('reference_type', 'Fast\RealEstate\Models\Type')
    ...
    public function down()
    {
        ...
        if (Schema::hasTable('language_meta')) {
            DB::table('language_meta')->where('reference_type', 'Fast\RealEstate\Models\Category')
                ->update(['reference_type' => 'Fast\RealEstate\Models\Type']);
        }
    }
}
