    ...
    <div class="container">
        <div class="row">
            <div class="group flexbox-annotated-section">
                ...
                <div class="col-md-9">
                    @php do_action(BASE_ACTION_META_BOXES, 'top', new \Fast\Payment\Models\Payment) @endphp
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                {!! Form::open() !!}
                                {!! Form::hidden('type', \Fast\Payment\Models\Payment::METHOD_PAYPAL, ['class' => 'payment_type']) !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                {!! Form::open() !!}
                                {!! Form::hidden('type', \Fast\Payment\Models\Payment::METHOD_STRIPE, ['class' => 'payment_type']) !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', new \Fast\Payment\Models\Payment) @endphp
            <div class="group">
                <div class="col-md-3">

                </div>
                <div class="col-md-9">
                    @php do_action(BASE_ACTION_META_BOXES, 'advanced', new \Fast\Payment\Models\Payment) @endphp
                </div>
            </div>
        </div>
    </div>
