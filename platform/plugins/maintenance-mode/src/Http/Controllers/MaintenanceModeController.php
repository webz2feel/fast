...
namespace Fast\MaintenanceMode\Http\Controllers;

use Assets;
use Fast\Base\Http\Responses\BaseHttpResponse;
use Fast\MaintenanceMode\Supports\MaintenanceMode;
use Fast\MaintenanceMode\Http\Requests\MaintenanceModeRequest;
...
class MaintenanceModeController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        Assets::addJavascriptDirectly(['vendor/core/plugins/maintenance-mode/js/maintenance.js']);
