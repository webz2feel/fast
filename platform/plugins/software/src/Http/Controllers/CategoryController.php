...
use Fast\Software\Forms\CategoryForm;
use Fast\Software\Tables\CategoryTable;
use Fast\Software\Http\Requests\CategoryRequest;
...
class CategoryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/software::categories.menu'));
    ...
    {
        page_title()->setTitle(trans('plugins/software::categories.create'));
    ...
    public function store(CategoryRequest $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setPreviousUrl(route('software-categories.index'))
            ->setNextUrl(route('software-categories.edit', $category->id))
    ...
    public function edit(Request $request, $id, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('plugins/software::categories.edit') . ' "' . $category->name . '"');
