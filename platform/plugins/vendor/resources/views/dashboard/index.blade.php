                      ...
                      <div class="white">
                          <div class="br2 pa3 bg-light-blue mb3" style="box-shadow: 0 1px 1px #ccc;">
                              <div class="media-body">
                                  <div class="f3">
                                      <span class="fw6">{{ $user->properties()->where('status', \Fast\RealEstate\Enums\PropertyStatusEnum::SELLING)->count() }}</span>
                  ...
                  <div class="col-md-4">
                      <div class="white">
                          <div class="br2 pa3 bg-light-red mb3" style="box-shadow: 0 1px 1px #ccc;">
                              <div class="media-body">
                                  <div class="f3">
                                      <span class="fw6">{{ $user->properties()->where('status', \Fast\RealEstate\Enums\PropertyStatusEnum::RENTING)->count() }}</span>
                  ...
                  <div class="col-md-4">
                      <div class="white">
                          <div class="br2 pa3 bg-light-silver mb3" style="box-shadow: 0 1px 1px #ccc;">
                              <div class="media-body">
                                  <div class="f3">
                                      <span class="fw6">{{ $user->properties()->where('status', \Fast\RealEstate\Enums\PropertyStatusEnum::SOLD)->count() }}</span>
