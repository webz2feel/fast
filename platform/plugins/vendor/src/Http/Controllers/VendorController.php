...
use Fast\Vendor\Forms\VendorForm;
use Fast\Vendor\Http\Resources\VendorResource;
use Fast\Vendor\Tables\VendorTable;
use Fast\Vendor\Http\Requests\VendorCreateRequest;
use Fast\Vendor\Http\Requests\VendorEditRequest;
