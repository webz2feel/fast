...
use Fast\Payment\Http\Requests\AfterMakePaymentRequest;
use Fast\Payment\Models\Payment;
use Fast\Payment\Services\Gateways\PayPal\PayPalPaymentService;
use Fast\Vendor\Http\Resources\PackageResource;
...
use Fast\Vendor\Http\Requests\AvatarRequest;
use Fast\Vendor\Http\Requests\SettingRequest;
use Fast\Vendor\Http\Requests\UpdatePasswordRequest;
